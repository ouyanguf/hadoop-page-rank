...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR dfs -copyFromLocal $HOME/mypagerank/input/medium-input Data
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR dfs -ls Data/medium-input
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR jar $HOME/mypagerank/PageRank.jar ouyang.PageRank Data/medium-input Outputs
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR dfs -ls Outputs
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR dfs -copyToLocal Outputs $HOME/output-medium
echo
